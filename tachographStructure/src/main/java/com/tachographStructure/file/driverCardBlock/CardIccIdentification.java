...
import com.tachographStructure.file.driverCardBlock.subBlocks.CardApprovalNumber;
...
public class CardIccIdentification extends Block implements CardBlock{
	...
	public CardIccIdentification (byte[] datos) throws IOException{
		...
		start+= DriverCardSizes.CLOCKSTOP.getMax();
		...
		start+= DriverCardSizes.CARDEXTENDEDSERIALNUMBER.getMax();
		...
		start+= DriverCardSizes.EMBEDDERICASSEMBLERID.getMax();
