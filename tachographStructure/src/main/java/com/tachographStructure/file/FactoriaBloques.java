    ...
    public static Block getFactoria(int word, byte[] datos) throws Exception {
        ...
        switch (word) {
            ...
            case 0x0501:
                ...
                break;
            case 0xc100:    // new in g2 charnge name EF_CARD_CERTIFICATE
                block = new CardCertificate(datos);
                block.setFID(Fid.EF_CARDMA_CERTIFICATE.toString());
                break;
            case 0xc101: // new in g2
                block = new CardCertificate(datos);
                block.setFID(Fid.EF_CARDSIGNCERTIFICATE.toString());
                break;
            case 0xc108:
            ...
            case 0x0522:
                ...
                break;
            case 0x523:
                System.out.println(Fid.EF_VEHICLEUNITS_USED.toString());
                break;
            case 0x524:
                System.out.println(Fid.EF_GNSS_PLACES.toString());
                break;
            // VEHICLES BLOCKS
            case 0x7601:
