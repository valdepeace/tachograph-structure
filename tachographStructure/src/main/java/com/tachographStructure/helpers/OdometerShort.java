 ...
 * 2.82. OdometerShort
 * 
 * Lectura del cuentakil�metros del veh�culo en forma abreviada.
 *
 * OdometerShort::= INTEGER(0..224-1)
 *
 * Asignaci�n de valor: n�mero binario sin signo. Valor en km en el intervalo operativo de 0 a 9999999 km.
 * 
